    ...
    while db_reconnect_status == 0:
        try:
            ...
            while 0 == db_reconnect2_status:
                print(Fore.RED + 'Reconnecting Database...' + '{:%Y-%m-%d %H:%M:%S}'.format(datetime.datetime.now(),
                                                                                            end='\r'))
                try:
...
def telnet_parser(telnet_result, todo_result, to_do_line, look_for, selected_list, looking_for):
    ...
    if search_result:  # Find Site Available For Normal Register
        print(Fore.YELLOW + str(todo_result[to_do_line][0]) + " : Site is not registered --> ", look_for, end='\r')
        # update table query
        ...
        print(Fore.YELLOW + str(todo_result[to_do_line][0]) + " : Special registration--> ", look_for, end='\r')
        # update Query
        ...
        if email:
            ...
            if search_unregable:
                ...
                # update Query
                print(Fore.YELLOW + str(todo_result[to_do_line][0]), ': Site registered No Email-->', look_for,
                      'Email:',
                ...
                if todo_result:
                    ...
                    for to_do_line in range(0, len(todo_result)):
                        ...
                        try:
                            ...
                            passed_counter += 1
                            print(Fore.RED + 'Telnet exception Passed -->', str(look_for), 'Count', passed_counter,
                                  end='\r')
